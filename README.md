...
- `server_url`에 GET 요청하여 200이면 정상, 그 외는 미연결로 판단

### 쓰레기통 목록/검색
`GET /trashcans?offset=0&limit=20&sort=total_desc&city=Seoul&name=TrashCan&address=Road&is_online=true`
...
### TrashCan
- 쓰레기통 기본 정보
- 주요 컬럼: `trashcan_id`, `trashcan_city`, `trashcan_capacity`, `server_url`, `is_online`, `is_deleted`
